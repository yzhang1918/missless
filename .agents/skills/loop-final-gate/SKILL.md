...
description: Evaluate whether a change is ready to land by combining review status, required CI checks, branch readiness, and documentation completeness into a go/no-go decision.
---
...
```sh
scripts/loop/final_gate.sh <review-json> <ci-json>
```
