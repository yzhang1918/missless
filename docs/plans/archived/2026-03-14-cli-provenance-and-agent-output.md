...
- Expected files:
  - `docs/plans/archived/2026-03-14-cli-provenance-and-agent-output.md`
  - `docs/specs/cli-contracts.md`
  - `docs/specs/pipeline-contracts.md`
  - `docs/design-docs/system-design.md`
  - `docs/specs/index.md`
...
- At the time, a separate harness-side reviewer-scope hardening record was
  archived outside the product-plan history so the product and harness
  execution narratives stayed split correctly.
