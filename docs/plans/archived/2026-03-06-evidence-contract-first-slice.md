...
- Expected files:
  - `docs/plans/archived/2026-03-06-evidence-contract-first-slice.md`
- Validation commands:
  - `rg -n "TASK-0001|TASK-0002|2026-03-06-evidence-contract-first-slice" docs/plans/archived/2026-03-06-evidence-contract-first-slice.md`
  - `git diff --check`
- Documentation impact:
...
- Evidence:
  ...
  - Archived this plan into `docs/plans/archived/` and synced the archived-plan catalog.
...
- Executed `rg -n "TASK-0001|TASK-0002|2026-03-06-evidence-contract-first-slice" docs/plans/archived/2026-03-06-evidence-contract-first-slice.md`; the archived-plan references remained aligned after archival.
- Executed `git diff --check`; no whitespace or patch-format issues were reported.
- Executed the archived-plan catalog sync check from `docs/plans/archived/README.md`; no missing catalog entries were reported.
