...
| ID | Title | Priority | Status | Owner | Links | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| TASK-0003 | Validate agent loop ergonomics after first real feature cycle | P2 | done | Human+Codex | `.agents/skills/AGENT_LOOP_WORKFLOW.md`, `docs/harness/completed/2026-03-09-post-first-slice-loop-remediation.md` | Completed: the ergonomics review was captured in a documentation-first follow-up record, the workflow now explicitly requires plan archival before publish/final gate, and remaining harness implementation work was decomposed into follow-ups `FUP-0004` through `FUP-0006`. |
