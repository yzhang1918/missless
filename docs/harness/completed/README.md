...
| [`2026-03-15-cli-dev-contract-cleanup.md`](./2026-03-15-cli-dev-contract-cleanup.md) | 2026-03-15 | Removed packaging-era contract signals from the current developer workflow, replaced tarball-install tests with activation-entrypoint coverage, and deferred future release packaging to issue `#42`. |
